...
Auto <- read.table("/Users/Home/Documents/Michael_Ghattas/School/CU_Boulder/BA-BS/2022/Fall/STAT 4610/Labs/Data/Auto.data")
View(Auto)
head(Auto)
```
...
```{r chunk26}
Auto <- read.table("/Users/Home/Documents/Michael_Ghattas/School/CU_Boulder/BA-BS/2022/Fall/STAT 4610/Labs/Data/Auto.data", header = T, na.strings = "?", stringsAsFactors = T)
View(Auto)
```
...
```{r chunk27}
Auto <- read.csv("/Users/Home/Documents/Michael_Ghattas/School/CU_Boulder/BA-BS/2022/Fall/STAT 4610/Labs/Data/Auto.data", na.strings = "?", stringsAsFactors = T)
View(Auto)
dim(Auto)
Auto[1:4, ]
```
